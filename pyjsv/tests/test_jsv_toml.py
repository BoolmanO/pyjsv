...
class TestSimpleToml(unittest.TestCase):
    def test_convert(self):
        st = SimpleToml.from_file(path.join(path_to_samples, "test_toml_1.toml"))
        toml_dict = \
        {
...
[servers]
    ...
    port = "8001"'''
        ...
        st_str = SimpleToml.from_string(toml_str)
    ...
    def test_read_write_files(self):
        ...
        st_reader = SimpleToml.from_file(path_to_tempfile)
